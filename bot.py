...
PROMTS = {
    ...
    "p006": {
        "title": "Cinematik portret",
        "category": "Portret",
        "promt": "Нижний ракурс, снято сильно снизу вверх Эффектный портрет молодой женщины с длинными, объемными крупными кудрями, сделанный с нижнего ракурса (рыбий глаз). Она одета в коричневую объемную оверсайз футболку свободного кроя. Девушка слегка улыбается, глядя в камеру, и изящно касается локтем своих волос, будто бы обвивает голову. Фон - бескрайнее ярко-синее небо, заполненное динамичными белыми кучевыми облаками, которые создают ощущение глубины и свободы. Идеальный тон лица губы в карандаше пыльная Роза Прозрачные очки прямоугольные  в серебристой оправе Естественное солнечное освещение подчеркивает текстуру кудрей и черты лица. Высокая детализация волос, кожи, яркие цвета, широкоугольная съемка, стиль современной мобильной фотографии для соцсетей. Гиперреализм 9:16"
    },
}
}
